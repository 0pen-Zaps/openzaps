...
Authenticated CLI verification on 2 August 2026 identified the production
shared project as `pool-fans-v2` with ref `jhzpyfzkdsyavgnnuzyu`, and confirmed
the OpenZaps migration ledger through
`20260802063540_marketing_tutorial_publication_receipts.sql`. The three older
remote-owned migration rows remain outside this repository and were not
repaired, reverted, renamed, or reapplied. Treat all of this as dated evidence:
reverify the project and migration ledger before a write.
