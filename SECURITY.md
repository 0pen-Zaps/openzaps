...
- Recovery is lineage-specific: owners can invalidate unused signed authority and recover tracked assets where the deployed lineage supports it. No recovery path can undo a confirmed execution.
