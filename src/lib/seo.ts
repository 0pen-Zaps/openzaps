...
export const STATIC_PAGE_SEO = {
  ...
  tokenization: {
    title: "Tokenize Uniswap Creator Fees",
    description:
      "Fractionalize Uniswap Instant Launch creator fees. Deposit your FEEB NFT, mint ERC20 shares, and earn pro-rata ETH fees. Live on Robinhood Chain.",
    path: "/tokenization",
    ogImage: "/og/token.png",
    changeFrequency: "weekly",
    priority: 0.7,
