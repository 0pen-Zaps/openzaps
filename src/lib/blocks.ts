...
export const BLOCKS: readonly LegoBlock[] = [
  ...
  },
  {
    ...
    kind: "guard",
    category: "guard",
    blurb: "Cap total outflow across all runs.",
    detail: "A cumulative budget tracked onchain. Once it is exhausted the zap stops executing until the owner re-signs.",
    accepts: null,
    emits: null,
    glyph: "gauge",
    gas: 0,
  ...
  },
  {
    ...
    kind: "guard",
    category: "guard",
    blurb: "Only execute inside an oracle band.",
    detail: "Reads an allowlisted oracle before execution and refuses to run outside the band — the anti-toxic-fill guard.",
    accepts: null,
    emits: null,
    glyph: "band",
    gas: 24_000,
  ...
  },
  {
    ...
    kind: "guard",
    category: "guard",
    blurb: "Restrict when the executor may run.",
    detail: "Bounds execution to a cadence and a deadline. An expired policy is dead weight rather than a standing authority.",
    accepts: null,
    emits: null,
    glyph: "clock",
    gas: 0,
  ...
  },
  {
    ...
    kind: "guard",
    category: "guard",
    blurb: "Require a wallet confirmation per run.",
    detail: "Every execution waits for a fresh signature. Maximum safety, minimum automation — usually reserved for large or novel routes.",
    accepts: null,
    emits: null,
    glyph: "hand",
    gas: 0,
  ...
  },
  {
    ...
    kind: "guard",
    category: "guard",
    blurb: "Skip the public mempool.",
    detail: "Sends through a private relay so the pending transaction is not visible to searchers before it lands.",
    accepts: null,
    emits: null,
    glyph: "eyeOff",
    gas: 0,
  ...
  },
  {
    ...
    detail:
      "Compounds the result into the first action instead of settling. Powerful and the easiest way to build unbounded exposure — pair it with a spend ceiling.",
    accepts: "token",
    emits: null,
    glyph: "loop",
    gas: 12_000,
