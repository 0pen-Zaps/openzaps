...
export const BLOCKS: readonly LegoBlock[] = [
  ...
  },
  {
    ...
    kind: "guard",
    category: "guard",
    blurb: "Designed to require a price to stay inside a band. Not enforced onchain.",
    detail: "A two-sided price band remains a design-only guard: the current trigger capsule enforces one signed direction, not a band. Use Price trigger when the condition must be executable.",
    accepts: null,
    emits: null,
    glyph: "band",
    gas: 24_000,
    maturity: "live",
    params: [
      { key: "band", label: "Band", type: "number", value: 3, min: 1, max: 50, step: 1, suffix: "%" },
    ],
  },
  {
    id: "price-trigger",
